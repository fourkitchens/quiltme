...
namespace Drupal\graphql_schema\Plugin\GraphQL\Schema;
...
/**
 * Schema file for graphql_schema.
 *
 * @Schema(
 *   id = "graphql_schema",
 *   name = "Graphql Schema"
 * )
 */
class GraphqlSchema extends SdlSchemaPluginBase implements ConfigurableInterface, PluginFormInterface {
